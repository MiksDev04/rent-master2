...
{
    $targetDir = $_SERVER['DOCUMENT_ROOT'] . "/rent-master2/admin/assets/tenants/";
    ...
    if ($uploadOk == 1 && move_uploaded_file($file["tmp_name"], $targetFile)) {
        return "/rent-master2/admin/assets/tenants/" . $fileName;
    } else {
...
<div class="container px-lg-5 mb-3">
    <header class="d-flex align-items-center mt-3 gap-2">
        ...
        <h4 class="fw-medium ">Tenants / Add Tenant</h4>
    </header>
