...
<div class="container px-lg-5 mb-4">
    <header class="d-flex align-items-center mt-3 gap-2">
        ...
        <h4 class="fw-medium">Tenant / Delete Tenant</h4>
    </header>

    <p class="text-warning">Are you sure you want to delete the following tenant? This action cannot be undone.</p>
    ...
    <form action="" method="POST">
        ...
        <div class="mt-3 d-flex gap-3">
            <button type="submit" class="btn btn-danger rounded-5">Delete Tenant</button>
