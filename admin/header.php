                ...
                <?php else: ?>
                    <div class="list-group list-group-flush">
                        <?php foreach ($notifications as $notification): ?>
                            ...
                            ?>
                            <a href="mark_as_read.php?id=<?= $notification['notification_id'] ?>&redirect=<?= urlencode($link) ?>" class="list-group-item list-group-item-action <?= $notification['is_read'] ? '' : 'bg-light' ?>">
