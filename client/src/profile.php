...
<body>
                ...
                <div class="account-card bg-white mb-4">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex justify-content-center flex-wrap gap-3 mb-4 r">
                            <label role="button" id="editProfileBtn" for="toggleEdit" type="button" class="btn  action-btn btn-link bg-light rounded-5">
                                <input type="checkbox" id="toggleEdit" style="display: none;">
                        ...
                        <form method="POST" enctype="multipart/form-data" id="profileForm">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="email" class="form-control" id="user_email" name="user_email" value="<?= htmlspecialchars($user['user_email'] ?? '') ?>" required disabled>
                                </div>
                                <div class="col-md-6">
    ...
    <script>
        ...
        document.getElementById('editProfileBtn').addEventListener('click', function(e)  {
            ...
            const isEditable = document.getElementById('toggleEdit');
            const inputs = form.querySelectorAll('input, textarea, button[type="submit"], button[type="button"]');

            inputs.forEach(input => {
                isClicked = isEditable.checked ? false : true;
                input.disabled = isClicked;
                e.currentTarget.style.border = !isClicked ? '1px solid blue' : '' ;
            });
